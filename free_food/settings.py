"""
Django settings for free_food project.
...
WSGI_APPLICATION = 'free_food.wsgi.application'
...
AUTHENTICATION_BACKENDS = ['django.contrib.auth.backends.ModelBackend', 'users.backend.NewBackend']
